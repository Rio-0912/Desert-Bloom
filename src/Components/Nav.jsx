  ...
  return (
    <div>
      <div className="h-[fit]  flex justify-center w-full bg-[#bda3a7] p-0.7 md:p-1">
        Use Code "INAYALOVE" To Get 10% OFF
      </div>
          ...
          <div className="flex items-center">
            ...
            {isLogedin ? (
              ...
              <section
                ...
                className="md:block flex gap-2 font-semibold items-center bg-gold_medium text-white text-sm rounded-full px-3 py-[4px]"
              >
      ...
      >
        ...
        <div className="flex justify-end items-center px-3 mt-5">
          ...
          {isLogedin ? (
            ...
            <section
              onClick={() => handleNavigation("/auth/login")}
              className="md:hidden flex gap-2 font-semibold items-center bg-gold_medium text-white text-sm rounded-full px-3 py-[4px]"
            >
              <p className="font-semibold cursor-pointer text-sm">Login</p>
            </section>
          )}
